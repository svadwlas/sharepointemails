...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <h2><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="">Alert templates</asp:HyperLink></h2><br/>
    <h2><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="">Xslt templates library</asp:HyperLink></h2><br/><br/>
